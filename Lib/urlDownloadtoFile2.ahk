...
---------------
	...
	fileDest (optional): local path to save to (defaults to script
...
---------------
	Example:
------------
urlDownloadToFile2("https://www.google.com/images/branding/googlelogo/1x/googlelogo_color_272x92dp.png")
------------
*/

urlDownloadToFile2(url,fileDest:="",userAgent:=""){
	if (!fileDest) {
		splitPath,url,fileDest
		fileDest := "C:\Users\zlegi\Desktop\" . fileDest
	}
